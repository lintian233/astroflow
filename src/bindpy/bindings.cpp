...
PYBIND11_MODULE(_astroflow_core, m) {
  ...
  m.def("_dedispered_fil", &dedispered_fil, py::arg("filename"),
        ...
        py::arg("freq_end"), py::arg("dm_step"),
        py::arg("time_downsample"), py::arg("t_sample"),
        py::arg("target") = GPU_TARGET, py::arg("target_id") = 0, py::arg("maskfile") = "mask.txt", py::arg("rficfg") = rficonfig());

  m.def("_dedispered_fil_with_dm_uint8",
        &cpucal::dedispered_fil_with_dm<uint8_t>, py::arg("fil"),
        py::arg("tstart"), py::arg("tend"), py::arg("dm"),
        py::arg("freq_start"), py::arg("freq_end"), py::arg("maskfile"), py::arg("rficfg"));
  ...
  m.def("_dedisperse_spec", &dedisperse_spec_py<uint8_t>, py::arg("data"),
        ...
        py::arg("t_sample") = 0.5, py::arg("target_id") = 0, py::arg("mask_file") = "mask.txt", py::arg("rficfg") = rficonfig());
  ...
  m.def("_dedisperse_spec", &dedisperse_spec_py<uint32_t>, py::arg("data"),
        ...
        py::arg("freq_start"), py::arg("dm_step") = 1,
        py::arg("ref_freq") = REF_FREQ_END, py::arg("time_downsample") = 2,
        py::arg("t_sample") = 0.5, py::arg("target_id") = 0, py::arg("maskfile") = "mask.txt", py::arg("rficfg") = rficonfig());

  m.def("_dedisperse_spec_with_dm", &dedisperse_spec_with_dm_gpu_py<uint8_t>,
  ...
  m.def("_dedisperse_spec_with_dm", &dedisperse_spec_with_dm_gpu_py<uint16_t>,
        py::arg("data"), py::arg("header"), py::arg("tstart"), py::arg("dm"),
        py::arg("tend"), py::arg("freq_start"), py::arg("freq_end"), py::arg("maskfile"), py::arg("rficfg"));
  m.def("_dedisperse_spec_with_dm", &dedisperse_spec_with_dm_gpu_py<uint32_t>,
        py::arg("data"), py::arg("header"), py::arg("tstart"), py::arg("dm"),
        py::arg("tend"), py::arg("freq_start"), py::arg("freq_end"), py::arg("maskfile"), py::arg("rficfg"));
